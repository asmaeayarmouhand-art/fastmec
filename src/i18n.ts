  ...
  es: {
    translation: {
      ...
      about: {
        ...
        desc1: 'En FastMec hemos revolucionado la forma de entender el taller mecánico. Llevamos la tecnología y la precisión de un taller de competición directamente a tu ubicación.',
      ...
      footer: {
        ...
        contacto: 'Contacto',
        derechos: '© 2024 FastMec. Todos los derechos reservados.',
        aviso: 'Aviso Legal',
        privacidad: 'Privacidad',
        cookies: 'Cookies',
        ubicacion: 'Servicio móvil en toda la Comunidad de Málaga y provincias limítrofes.',
  ...
  en: {
    translation: {
      ...
      about: {
        ...
        desc1: 'At FastMec we have revolutionized the way people understand the mechanical workshop. We bring the technology and precision of a competition workshop directly to your location.',
      ...
      footer: {
        ...
        contacto: 'Contact',
        derechos: '© 2024 FastMec. All rights reserved.',
        aviso: 'Legal Notice',
        privacidad: 'Privacy',
        cookies: 'Cookies',
        ubicacion: 'Mobile service in the entire Community of Malaga and surrounding provinces.',
  ...
  fr: {
    translation: {
      nav: {
        ...
        contacto: 'Contact',
        solicitar: 'Demander un Service'
      },
      hero: {
        disponible: 'Service Disponible 24 Heures',
        titulo: 'Votre atelier de confiance',
        subtitulo: 'sur roues',
        descripcion: 'Mécanique mobile professionnelle pour voitures, camions et tracteurs. Nous vous rejoignons où que vous soyez en moins de 60 minutes.',
        cta_ahora: 'Demander un service maintenant',
        cta_llamar: 'Appeler Directement'
      },
      about: {
        premium: 'Service Premium',
        premium_desc: 'Plus de 500 avis positifs de clients satisfaits dans toute la région.',
        titulo_start: 'Experts en mécanique mobile',
        titulo_accent: 'haute performance',
        desc1: 'Chez FastMec, nous avons révolutionné la façon dont les gens comprennent l\'atelier mécanique. Nous apportons la technologie et la précision d\'un atelier de compétition directement à votre emplacement.',
        desc2: 'Notre unité mobile est équipée de systèmes de diagnostic avancés et d\'outils de précision pour garantir que chaque réparation répond aux normes les plus élevées de l\'industrie.',
        items: {
          asistencia: 'Assistance routière',
          maquinaria: 'Machines agricoles',
          vehiculos: 'Véhicules industriels',
          diagnosis: 'Diagnostic électronique',
          garantia: 'Garantie écrite',
          precios: 'Prix fixes'
        }
      },
      servicios: {
        titulo: 'Nos Services',
        subtitulo: 'Solutions complètes pour tout type de véhicule. De l\'entretien le plus basique aux pannes les plus complexes, le tout à votre porte.',
        coche: {
          title: 'Réparation de Voitures',
          desc: 'Entretien officiel, freins, suspension et mécanique générale pour voitures particulières de toutes marques.'
        },
        camion: {
          title: 'Réparation de Camions',
          desc: 'Spécialistes des systèmes pneumatiques, hydrauliques et de la mécanique lourde pour le transport professionnel.'
        },
        tractor: {
          title: 'Réparation de Tracteurs',
          desc: 'Assistance immédiate sur le terrain pour les machines agricoles. Nous évitons les temps d\'arrêt coûteux dans votre production.'
        },
        diagnosis: {
          title: 'Diagnostic Moteur',
          desc: 'Équipements de diagnostic de dernière génération pour détecter les pannes électroniques et optimiser les performances.'
        },
        aceite: {
          title: 'Vidange d\'Huile',
          desc: 'Entretien préventif avec des lubrifiants haut de gamme et gestion professionnelle des déchets.'
        },
        frenos: {
          title: 'Freins et Batteries',
          desc: 'Remplacement immédiat des composants de sécurité. Nous ne travaillons qu\'avec les meilleures marques.'
        },
        saber_mas: 'En savoir plus'
      },
      como: {
        titulo: 'Comment ça Marche',
        subtitulo: 'Votre mécanicien à un clic',
        paso1: {
          title: 'Contact',
          desc: 'Appelez-nous ou écrivez-nous sur WhatsApp. Indiquez-nous votre emplacement et les symptômes de votre véhicule.'
        },
        paso2: {
          title: 'Diagnostic',
          desc: 'Notre unité mobile se déplace à votre emplacement pour effectuer une évaluation technique complète.'
        },
        paso3: {
          title: 'Réparation',
          desc: 'Nous résolvons le problème sur place avec une garantie professionnelle. Reprenez la route sans attendre.'
        }
      },
      cta: {
        titulo: 'Êtes-vous en panne ?',
        subtitulo: 'N\'appelez pas encore la dépanneuse. Notre équipe peut résoudre la plupart des pannes sur place.',
        llamar: 'Appeler Maintenant',
        whatsapp: 'WhatsApp 24h'
      },
      contacto: {
        titulo_start: 'Nous sommes prêts à',
        titulo_accent: 'vous aider',
        subtitulo: 'Nos mécaniciens sont répartis stratégiquement pour atteindre n\'importe quel point de la région en un temps record.',
        labels: {
          llamada: 'Appel Direct',
          whatsapp: 'WhatsApp Urgent',
          correo: 'E-mail'
        },
        values: {
          whatsapp: 'Chat en direct 24/7'
        },
        form: {
          titulo: 'Demander un devis',
          nombre: 'Nom',
          telefono: 'Téléphone',
          vehiculo: 'Véhicule et Problème',
          placeholder_nombre: 'Votre nom',
          placeholder_telefono: 'Votre mobile',
          placeholder_mensaje: 'Ex : BMW Série 3, ne démarre pas. Je suis à la Rue Principale...',
          enviar: 'Envoyer une Demande Urgente',
          error: 'Une erreur s\'est produite lors de l\'envoi de la demande. Veuillez réessayer.'
        }
      },
      footer: {
        desc: 'Leaders de la mécanique mobile. Professionnalisme, rapidité et transparence dans chaque réparation.',
        especialidades: 'Spécialités',
        items: {
          turismos: 'Voitures et SUVs',
          transporte: 'Transport Lourd',
          maquinaria: 'Machines Agricoles',
          hibridos: 'Systèmes Hybrides'
        },
        navegacion: 'Navigation',
        contacto: 'Contact',
        derechos: '© 2024 FastMec. Tous droits réservés.',
        aviso: 'Mentions Légales',
        privacidad: 'Confidentialité',
        cookies: 'Cookies',
        ubicacion: 'Service mobile dans toute la Communauté de Malaga et les provinces environnantes.',
        disponible: 'Disponible 24 heures / 365 jours'
      },
      common: {
        volver: 'Retour à l\'accueil'
      },
      privacy: {
        intro: 'Conformément aux dispositions du règlement (UE) 2016/679 du Parlement européen et du Conseil du 27 avril 2016 (RGPD) et de la loi organique 3/2018 relative à la protection des données à caractère personnel et à la garantie des droits numériques (LOPDGDD), les utilisateurs du site web sont informés de la politique de confidentialité suivante concernant le traitement des données à caractère personnel.'
      }
    }
  }
};
